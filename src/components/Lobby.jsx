  ...
  const renderSpyLobby = () => (
    <div className="whoami-lobby spy-lobby">
      <div className="section-heading">
        <h2>Лобби «Шпион»</h2>
        <p>
          По выбранной теме все, кроме одного шпиона, видят одного и того же персонажа. Шпион не знает, кто это.
      ...
      <div className="lobby-footer">
        <div className="lobby-info">
          ...
          {canStartSpy && (
            <p className="hint-text">
              Старт заново выбирает шпиона, общего персонажа и порядок ходов.
            </p>
          )}
        </div>
        <button
